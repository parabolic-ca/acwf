...
// Copyright 2014 Jeffrey Yeo. All rights reserved.
//===================================================================
...
// classes.
ACWF.PhasorDiagram = function(_elementId) {
	...
	this.plotWaveformSet = function(waveformSet, reference, acwfOptions) {
		...
		phasor.drawPhasors(engine.getShapes());
	}
